...
function Sidebar() {
    ...
    const menuItems = [
        ...
        { to: "/connection", icon: "connect.svg", label: tSidebar.connection, hasArrow: true,modal:'connectionModal' },
        ...
        { to: "/credits", icon: "moneybag.svg", label: tSidebar.credits, hasArrow: true,modal:'creditModal'},
