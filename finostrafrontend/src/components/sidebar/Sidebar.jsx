            ...
            <nav>
                <ul>
                    ...
                    <li><Link to="translations" className={styles.iconContainer}>
                        <img src="./icons/transfer.svg"/>
                        <div className={styles.iconWrapper}>
                            <div>Перекази</div>
                            <img src="./icons/dir_right.svg"/>
                        </div>
                    </Link></li>
                    ...
                    <li><Link to="conversions" className={styles.iconContainer}>
                        <img src="./icons/conversions.svg"/>
                        <div className={styles.iconWrapper}>
                            <div>Конверти</div>
                        </div>
                    </Link></li>
                    <li><Link to="piggy_bank" className={styles.iconContainer}>
                        <img src="./icons/piggy_bank.svg"/>
                        <div className={styles.iconWrapper}>
                            <div>Скарбничка</div>
                        </div>
                    </Link></li>
