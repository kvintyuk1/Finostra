...
const transferModalItems = [
    ...
    {img: "modal_payoneer", title: "Payoneer", path: "/transactions/payoneer", modal:"payoneerModal"},
]
        ...
        <div className={styles.overlay} onClick={handleOverlayClick}>
            <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
                <div className={styles.modal_content}>
                    {
                        transferModalItems.map(({img, title, path,modal}) => (
                            <div key={title} className={styles.wrapper_item}>
                                <div className={styles.item}>
                                    <img src={`/icons/${img}.svg`} alt=""/>
                                    {
                                        modal === "payoneerModal" ? (
                                            <span onClick={openPayoneerModal}>{title}</span>
                                        ) : (
